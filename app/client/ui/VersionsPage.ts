...
import { ActionLogPart } from '../components/ActionLog';
import { testId } from '../lib/dom';
import { bigPrimaryButton } from '../ui2018/buttons';
  ...
  public buildDom() {
    ...
    return cssContainer(
      ...
      dom.forEach(this._offers, offer1 => {
        return cssDataRow(dom.maybe(offer1.info, offer => {
          ...
          parts.push(dom('div', `Offered by: ${name}`));
          const part = new ActionLogPart(() => true, () => Promise.resolve());
